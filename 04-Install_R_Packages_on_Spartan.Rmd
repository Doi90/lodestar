...
The `.bash_profile` method is perfetly fine as long as you only need to have a single personal library. You will need to update it anytime you switch to a new R version module. 
